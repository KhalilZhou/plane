from plane.prompt_prefix import build_prompt_prefix, tool_signature
from plane.tools import build_tool_registry
from plane.workspace import WorkspaceContext
...
def test_build_prompt_prefix_renders_tools_and_workspace_metadata(tmp_path):
    ...
    assert "You are plane" in prefix.text
